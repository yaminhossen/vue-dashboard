<template>
    <div class="card">
        <div class="user_header">
            <span>All</span>
            <span><input type="search" name="" id="" placeholder="Search"></span>
            <div>
                <span>Create</span>
                <span>!!!</span>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action_div">
                                <button class="btn action_btn"><i class="fa-solid fa-ellipsis-vertical"></i>
                                </button>
                                <div class="action_dropdown ">
                                    <div>
                                        <div>
                                            <a class=""><i class="ti ti-pencil me-1"></i>
                                                Edit
                                            </a>
                                        </div>
                                        <div>
                                            <a class=""><i class="ti ti-trash me-1"></i>
                                                Delete
                                            </a>
                                        </div>
                                        <div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-5">
                            <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_1_paginate">
                                <ul class="pagination">
                                    <li class="paginate_button page-item  disabled" id="DataTables_Table_1_previous"><a
